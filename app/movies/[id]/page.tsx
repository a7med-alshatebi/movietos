...
const mockMovieDetails: { [key: string]: MovieDetail } = {
  ...
  "the-fast-and-the-furious": {
    ...
    backdrop: "/The Fast and the Furious.webp",
    rating: 6.8,
    year: 2001,
    runtime: 106,
  ...
  "the-shawshank-redemption": {
    ...
    backdrop: "/The Shawshank Redemption.jpeg",
    rating: 9.3,
    year: 1994,
    runtime: 142,
    genre: "Drama",
  ...
  "guardians-of-the-galaxy": {
    ...
    backdrop: "/guardiansofthegalaxy.jpeg",
    rating: 8.0,
    year: 2014,
    runtime: 121,
  ...
  "mad-max-fury-road": {
    ...
    backdrop: "/Mad Max_ Fury Road.jpeg",
    rating: 8.1,
    year: 2015,
    runtime: 120,
    genre: "Action, Adventure, Sci-Fi",
